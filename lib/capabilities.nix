{
  flake.lib.capabilities = {
    ...
    gpu            = { _type = "gpu";            };
    audio          = { _type = "audio";          };
    bluetooth      = { _type = "bluetooth";      };
    wifi           = { _type = "wifi";           };
    zfs            = { _type = "zfs";            };
    virtualization = { _type = "virtualization"; };
  };

  flake.lib.hasCapability = cap: caps:
    builtins.any (c: c._type == cap) caps;

  flake.nixosModules.capabilities = { lib, ... }: {
